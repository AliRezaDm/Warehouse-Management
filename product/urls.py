...
urlpatterns = [
    ...
    path('delete_category/<int:id>', views.CategoryUpdateView.as_view(), name='category_delete' ), 
    ...
    path('delete_color/<int:id>', views.ColorUpdateView.as_view(), name='color_delete' ),
    ...
    path('delete_size/<int:id>', views.SizeUpdateView.as_view(), name='size_delete' ), 
